                ...
                <form class="was-validated" method="POST" action="{{ route('orders.store') }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div>
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="alco3" name="alcohol_level" class="custom-control-input" value="Extra Strong" {{ old('Extra Strong')==="Regular" ? 'checked='.'"'.'checked'.'"' : '' }}required>
                    ...
                    <div class="form-row">
                        ...
                        <textarea name="additional_instructions"
                                  ...
                                  type="text"
                                  placeholder="Name your allergies here">{{old('additional_instructions')}}</textarea>
                            </div>
